...
Schedule 30-minute 1-1 meetings between a visitor and department colleagues.

## Colleague Flow

1. Open [`availability.html`](https://remy.wang/sched/availability.html)
...
1. Open [`schedule.html`](https://remy.wang/sched/schedule.html)
